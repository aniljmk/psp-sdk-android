...
public class StcPay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            Toast.makeText(StcPay.this, "Payment gateway Username Required!", Toast.LENGTH_SHORT).show();
        }
        else if (TextUtils.isEmpty(pass))
        {
            Toast.makeText(StcPay.this, "Payment gateway Password Required!", Toast.LENGTH_SHORT).show();
        }
        else if (TextUtils.isEmpty(key_s))
        {
            Toast.makeText(StcPay.this, "key missing!", Toast.LENGTH_SHORT).show();
        }
        else if (TextUtils.isEmpty(details_josn))
        {
            Toast.makeText(StcPay.this, "data missing!", Toast.LENGTH_SHORT).show();
        }
        else
        {
        ...
        protected Object doInBackground(Object[] objects) {
            ...
            JSONObject js;
            {
                try {
                    ...
                    mobile_number = quotes + js.getString("mobile_number") +quotes;
                    merchant_note = quotes + js.getString("merchant_note") +quotes;
