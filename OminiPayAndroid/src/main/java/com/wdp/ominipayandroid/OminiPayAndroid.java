...
public class OminiPayAndroid extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_omini_pay_android);
        ...
        {
            Toast.makeText(OminiPayAndroid.this, "Payment gateway Username Required!", Toast.LENGTH_SHORT).show();
        }
        else if (TextUtils.isEmpty(pass))
        {
            Toast.makeText(OminiPayAndroid.this, "Payment gateway Password Required!", Toast.LENGTH_SHORT).show();
        }
        else if (TextUtils.isEmpty(key_s))
        {
            Toast.makeText(OminiPayAndroid.this, "key missing!", Toast.LENGTH_SHORT).show();
        }
        else if (TextUtils.isEmpty(details_josn))
        {
            Toast.makeText(OminiPayAndroid.this, "data missing!", Toast.LENGTH_SHORT).show();
        }
        else
        {
